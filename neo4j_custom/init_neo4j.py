...
query_follow = """
LOAD CSV WITH HEADERS FROM 'C:/Users/frang/Desktop/project_nosql/neo4j_custom/docs/tw_user_follow.csv' AS row
...
query_retweet = """
LOAD CSV WITH HEADERS FROM 'C:/Users/frang/Desktop/project_nosql/neo4j_custom/docs/tweet_retweet.csv' AS row
